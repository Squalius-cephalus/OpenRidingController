...
class ReinsHandler:
    ...
    def update(self):
        ...
        self.update_states(current_time, combined_value)

    def update_states(self, current_time, combined_value):
    ...
    def update_analog(self):
        ...
        """
        left_value = left_rein_input.value
        right_value = right_rein_input.value
        if self._invert:
            left_value = 65535 - left_value
            right_value = 65535 - right_value

        self.left_input = interpolate(left_value, self.reins_curve)
        self.right_input = interpolate(right_value, self.reins_curve)
    ...
    def calibration(self):
        ...
        if self._invert:
            left_value = 65535 - left_value
            right_value = 65535 - right_value
        print(left_value>>7, right_value>>7)
